            ...
            <div class="user-info">
                ...
                <c:if test="${sessionScope.user != null}">
                    ...
                    <c:if test="${sessionScope.user.role == 'admin'}">
                        <a href="/admin/product/list">管理后台</a> | 
                    </c:if>
    ...
    <div class="container">
        <div class="search-bar">
            <form action="/product/search" method="get" onsubmit="return handleSearch(this)">
                ...
                <button type="button" onclick="window.location.href='/product/list'">商品列表</button>
            </form>
        </div>
        ...
        <div class="product-list">
            <c:choose>
                ...
                <c:otherwise>
                    <p style="text-align: center; padding: 20px; color: #666;">暂无商品，请先添加商品</p>
                </c:otherwise>
            </c:choose>
        </div>
    </div>
